...
3. **Tauri 릴리스 후보** — `e3b5fe883`에서 실제 Tauri·Provider·workspace 파일 문맥·재시작 증분 UAT를 통과했지만, 전체 원자 UAT와 설치·서명 검증은 남아 있습니다. [증거](docs/evidence/phase-30/desktop-live-tauri-uat-2026-07-26-e3b5fe883.md)
