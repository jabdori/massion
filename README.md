...
3. **Tauri 릴리스 후보** — `be7a552cb`에서 bundle 빌드와 실제 native 파일 패널 호출을 증분 확인했지만, 파일 선택 완료·전체 원자 UAT와 설치·서명 검증은 남아 있습니다. [증분 증거](docs/evidence/phase-30/desktop-live-native-file-panel-uat-2026-07-26-be7a552cb.md)
