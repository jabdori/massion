...
> **2026-07-24 범위 명시:** 아래 실행은 개인 소유 계정·키를 격리된 로컬 Massion에 직접 등록한 BYOK 도그푸딩입니다. 키·계정·할당량을 다른 사용자에게 공유·대여·판매·중계하지 않았습니다. 개발·테스트 작성·실패 패치에도 Coding Plan `glm-5.2`를 계속 사용합니다.
