...
- 최신 artifact 서명·공증 gate: [실제 결과](./desktop-artifact-signing-2026-07-27-573297642.md)
...
| Developer ID 서명·공증·sidecar 서명 | 미완료 | 현재 후보의 실제 ad-hoc bundle이 `codesign`·`spctl`·`stapler`에서 거부됨. Developer ID와 Apple credential이 필요하며 ad-hoc은 통과로 인정하지 않음. [실측](./desktop-artifact-signing-2026-07-27-573297642.md) |
