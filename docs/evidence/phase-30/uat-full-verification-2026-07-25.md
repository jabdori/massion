# UAT 자동화 대응 검증(실제 Tauri UAT 아님) — 2026-07-25

> 각 `PASS`는 fixture UI 또는 백엔드 자동화의 통과이며 실제 Tauri 사용자 인수 테스트 완료를 뜻하지 않습니다. 네이티브 대화상자, 설치·업데이트·복구, 서명·공증을 대체하지 않습니다. 실제 Tauri 증분 결과는 [동일 후보 UAT 증거](./desktop-live-tauri-uat-2026-07-26-e3b5fe883.md)에 별도로 기록합니다.
