...
> **현재 상태 정정:** 아래 GitHub `v1.0.0` 관측은 2026-07-18 당시의 역사적 사실입니다. GitHub Release는 2026-07-24 삭제됐고 잘못된 원격 태그도 삭제됐습니다. 로컬 배포 계약 검증은 보존하지만 현재 공개 릴리스나 개인용 데스크톱 완료 근거로 사용하지 않습니다. [철회 증거](./withdrawn-v1.0.0-release-2026-07-24.md)
...
- 당시 `Massion AgentOS 1.0.0` 공개 릴리스는 2026-07-15T18:05:57Z에 게시됐고 draft·prerelease 모두 `false`였습니다. 현재 상태는 [철회 기록](./withdrawn-v1.0.0-release-2026-07-24.md)을 따릅니다.
...
따라서 이 Slice 1A의 로컬 검증을 공개 registry 게시, attestation, 새 release 성공으로 해석하지 않습니다. 당시에는 기존 `v1.0.0` tag를 이동하거나 재생성하지 않았습니다. 해당 GitHub Release와 잘못된 태그는 모두 삭제됐으며 공개 릴리스나 다운로드 artifact는 존재하지 않습니다.
