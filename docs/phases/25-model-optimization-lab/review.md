...
tmux release 시나리오는 최신 local archive에서 설치·시작·재시작·backup·restore·uninstall data 보존까지 통과했습니다. 실제 Provider 품질 분포와 subscription run은 OAuth·외부 계정 인증 및 네트워크 응답이 필요해 성공으로 기록하지 않았습니다. 최신 local receipt와 release digest는 `docs/evidence/phase-24/subscription-uat-2026-07-14.md`에 기록했습니다.
