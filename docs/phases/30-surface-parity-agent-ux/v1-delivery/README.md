...
| 05 | 실제 데스크톱 UAT와 개인용 릴리스 후보 | 최신 후보의 실제 Tauri·Provider·재시작 증분 통과 · 전체 native UAT·릴리스 게이트 대기 | [최신 동일 후보 Tauri/API UAT](../../../evidence/phase-30/desktop-live-tauri-uat-2026-07-26-6eb14efcb.md) |
