...
| 04 | Core·협업·조직·개선·권한·수신함 정합화 | 부분 진행 — Core UAT·Growth Reflection timeout/fallback·Work 오류 가시성·Provider capability/fallback·bundled runtime 증분 | [페이즈 04](./phase-04-core-collaboration-permission-inbox.md) |
