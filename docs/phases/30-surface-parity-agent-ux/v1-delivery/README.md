...
| 02 | 네이티브 폴더·파일 선택 | 대기 | Task 3 완료 뒤 작성 |
| 03 | 지식 그래프·검색·기억의 업무 연결 | 대기 | 지식·기억 선행 게이트 시작 시 작성 |
| 04 | Core·협업·조직·개선·권한·수신함 정합화 | 대기 | 각 하위 경계가 시작될 때 분리 작성 |
| 05 | 실제 데스크톱 UAT와 개인용 릴리스 후보 | 대기 | 23개 원자 UAT 시작 시 작성 |
