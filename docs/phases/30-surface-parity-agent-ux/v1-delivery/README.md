...
| 04 | Core·협업·조직·개선·권한·수신함 정합화 | 부분 진행 — Core UAT·Growth review/adoption·재시작 계보 정합화·timeout/fallback·Work 오류 가시성·Provider capability/fallback·bundled runtime 증분; 효과 cohort는 Provider 실패로 대기 | [페이즈 04](./phase-04-core-collaboration-permission-inbox.md) |
