...
> **2026-07-24 상태 정정:** 아래 “완료”는 과거 로컬 런타임 조각에 한정됩니다. 현재 개인용 데스크톱 제품과 공개 1.0은 완료되지 않았으며, 남은 메인 릴리스 실행 순서는 [제품 통합 계획](../../superpowers/plans/2026-07-24-phase-30-product-integration.md)이 대체합니다.
