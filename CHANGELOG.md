...
2026-07-15 게시된 GitHub Release와 `v1.0.0` 원격 태그를 2026-07-24 삭제했습니다. 당시 릴리스 workflow가 전체 품질 검증에서 실패했고, 현재 메인 표면인 개인용 데스크톱의 실제 UAT·서명·공증·설치·데이터 지속성·장애·접근성 게이트가 완료되지 않았기 때문입니다. 소스 커밋과 아래 역사적 구현 범위는 보존하지만 공개 1.0 완료 근거로 사용하지 않습니다.
